...
function getTeamPerformance(){
	...
	if($type != ""){
		...
		$super_query = "select s.year as year , count(*) as total from series s where s.type like '%".$type."%' and s.id in (select distinct m.series_id from matches m, teams t where t.id = ".$team_id." and (m.team1 = ".$team_id." or m.team2 = ".$team_id.")) group by s.year";
		$sub_query = "select s.year as year , count(*) as wins from series s where s.type like '%".$type."%' and s.winner = ".$team_id." and s.id in (select distinct m.series_id from matches m, teams t where t.id = ".$team_id." and (m.team1 = ".$team_id." or m.team2 = ".$team_id.")) group by s.year";
		$draw_query = "select s.year as year, count(*) as drawn from series s where s.type like '%".$type."%' and s.winner = -1 and s.id in (select distinct m.series_id from matches m, teams t where t.id = ".$team_id." and (m.team1 = ".$team_id." or m.team2 = ".$team_id.")) group by s.year";
		//echo $super_query;	
	}else{
		...
		$super_query = "select s.year as year, count(*) as total from series s where s.id in (select distinct m.series_id from matches m, teams t where t.id = ".$team_id." and (m.team1 = ".$team_id." or m.team2 = ".$team_id.")) group by s.year";
		$sub_query = "select s.year as year, count(*) as wins from series s where s.winner = ".$team_id." and s.id in (select distinct m.series_id from matches m, teams t where t.id = ".$team_id." and (m.team1 = ".$team_id." or m.team2 = ".$team_id.")) group by s.year";
		$draw_query = "select s.year as year, count(*) as drawn from series s where s.winner = -1 and s.id in (select distinct m.series_id from matches m, teams t where t.id = ".$team_id." and (m.team1 = ".$team_id." or m.team2 = ".$team_id.")) group by s.year";
	}
