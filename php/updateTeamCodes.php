...
$result = mysql_query("select t.id as id, t.code as code from series s, teams t where t.code = s.winner");

while($row = mysql_fetch_assoc($result)){
	//echo "Match : ".$row['team1']." vs ".$row['team2']." on ".$row['date']."  Type: ".$row['type']."<br />";
	echo "Match - ".$row['id']." -> ".$row['code']."<br />";
	mysql_query("update series set winner = '".$row['id']."' where winner LIKE '".$row['code']."'   ");
}
